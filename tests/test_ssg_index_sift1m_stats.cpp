...
static void compute_stats(const char* graph_file, const uint32_t feature_dims, const char* top_list_file) {
    ...
    auto index = efanna2e::IndexSSG(feature_dims, top_list_count, efanna2e::L2, nullptr);
...
int main(int argc, char** argv) {
    ...
    auto ssg_file         = R"(c:/Data/Feature/SIFT1M/ssg/sift.ssg)"; // GQ 0.418916, avg degree 39.1018, min_out 4, max_out 50, min_in 4, max_in 159, zero in nodes 0
    auto top_list_file = R"(c:/Data/Feature/SIFT1M/SIFT1M/sift_base_top200_p0.998.ivecs)";
    compute_stats(ssg_file, 128, top_list_file);
