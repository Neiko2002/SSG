...
int main(int argc, char** argv) {
  ...
  bool optimize_graph = true;  // uses normalized distances and DistanceFastL2 and prefetching
  unsigned K = 100;
  ...
  // create the index
  auto distanceMetric = (optimize_graph) ? efanna2e::FAST_L2 : efanna2e::L2;
  efanna2e::IndexSSG index(dim, points_num, distanceMetric, nullptr);
  index.Load(ssg_file);
  if(optimize_graph) 
